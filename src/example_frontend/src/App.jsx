...
function App() {
  ...
  const handleAddDepartment = async (event) => {
    ...
    try {
      ...
      const existingDepartment = departments.find(dep => dep.DeptId === newDepartment.DeptId);
      const existdepname = departments.find(deps => deps.departmentName === newDepartment.departmentName);
      if (existingDepartment) {
        alert('Please!! No duplicate allowed. Already exists!');
        return;
      }
